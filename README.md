...
[![CI](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-service-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-service-aws/actions/workflows/ci.yml)
[![Release](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-service-aws/actions/workflows/auto-release.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-service-aws/actions/workflows/auto-release.yml)
[![CodeQL](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-service-aws/actions/workflows/codeql.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-service-aws/actions/workflows/codeql.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)
[![Latest Release](https://img.shields.io/github/v/release/PlatformStackPulse/tf-atom-vpc-endpoint-service-aws)](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-service-aws/releases)

---

## Purpose

Terraform atom module for a single AWS VPC Endpoint Service resource. Creates a PrivateLink service that allows other AWS accounts to connect to your service via VPC endpoints.
...
module "vpc_endpoint_service" {
  source = "git::https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-service-aws.git?ref=v1.1.0"
...
|------|-------------|------|---------|:--------:|
| <a name="input_acceptance_required"></a> [acceptance\_required](#input\_acceptance\_required) | Whether VPC endpoint connection requests require manual acceptance. | `bool` | `true` | no |
...
| <a name="input_gateway_load_balancer_arns"></a> [gateway\_load\_balancer\_arns](#input\_gateway\_load\_balancer\_arns) | List of Gateway Load Balancer ARNs to associate with the endpoint service. | `list(string)` | `[]` | no |
...
| <a name="input_network_load_balancer_arns"></a> [network\_load\_balancer\_arns](#input\_network\_load\_balancer\_arns) | List of Network Load Balancer ARNs to associate with the endpoint service. | `list(string)` | `[]` | no |
| <a name="input_private_dns_name"></a> [private\_dns\_name](#input\_private\_dns\_name) | Private DNS name for the endpoint service. | `string` | `null` | no |
...
| <a name="output_endpoint_service_arn"></a> [endpoint\_service\_arn](#output\_endpoint\_service\_arn) | The ARN of the VPC Endpoint Service. |
...
| <a name="output_service_name"></a> [service\_name](#output\_service\_name) | The service name of the VPC Endpoint Service for consumers. |
